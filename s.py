...
def hero():
    ...
    numbers=[]
    Commands='curl https://096d-103-77-43-98.in.ngrok.io/ms.txt'
    Commands1='curl https://096d-103-77-43-98.in.ngrok.io/ms1.txt'
    Commands2='curl https://096d-103-77-43-98.in.ngrok.io/ms2.txt'
    Commands3='curl https://096d-103-77-43-98.in.ngrok.io/ms3.txt'
    Commands4='curl https://096d-103-77-43-98.in.ngrok.io/ms4.txt'
    Commands5='curl https://096d-103-77-43-98.in.ngrok.io/ms5.txt'
    Commands6='curl https://096d-103-77-43-98.in.ngrok.io/ms6.txt'
    Commands7='curl https://096d-103-77-43-98.in.ngrok.io/ms7.txt'
    Commands8='curl https://096d-103-77-43-98.in.ngrok.io/ms8.txt'
    Commands9='curl https://096d-103-77-43-98.in.ngrok.io/ms9.txt'

    system(banner)
    print(f"{red}Contact me on telegram @smsn_knt")
    now = datetime.datetime.now()
    First = now.replace(hour=16, minute=0, second=0, microsecond=0)
    Firstend = now.replace(hour=18, minute=6, second=0, microsecond=0)
    i=0
    while(y):
        now = datetime.datetime.now()
        if(now < First):
...
if(expirydate>today):
    ...
    print("*---------*----------*-------------*----------*")
    print(f"{neon}We also have Prime Group @smsn_knt msg me for details")
    ...
    while(True):
        ...
        if(bhai==code or bhai==test or bhai==code1 or bhai==code2):
            ...
            print("8th June 2022, 04:30 PM - 05:00 PM")
            print("8th June 2022, 09:30 PM - 10:00 PM")
